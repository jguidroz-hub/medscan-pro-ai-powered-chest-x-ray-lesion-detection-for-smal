  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">MedScan Pro - AI-powered chest X-ray lesion detection for small clinics</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Automated chest X-ray analysis that helps small clinics and radiologists detect lesions with hospital-grade accuracy, reducing misdiagnosis and improving patient outcomes without expensive equipment upgrades.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust MedScan Pro - AI-powered chest X-ray lesion detection for small clinics.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} MedScan Pro - AI-powered chest X-ray lesion detection for small clinics. All rights reserved.</p>
