  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="MedScan Pro - AI-powered chest X-ray lesion detection for small clinics-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
