...
const FROM = process.env.EMAIL_FROM || 'MedScan Pro - AI-powered chest X-ray lesion detection for small clinics <noreply@example.com>';
const APP_NAME = 'MedScan Pro - AI-powered chest X-ray lesion detection for small clinics';
